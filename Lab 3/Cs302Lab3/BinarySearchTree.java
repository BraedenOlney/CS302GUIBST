...
public class BinarySearchTree<E> extends AbstractSet<E> implements Serializable
{
    ...
    *
    *  @return true - if this BinarySearchTree object changed as a result of this
    *                method call (that is, if obj was actually removed);
   otherwise,
    *                return false.
    *
    *  @throws ClassCastException - if obj cannot be compared to the
   ...
   protected class TreeIterator implements Iterator<E>
   {
       ...
       *  Determines if there are still some elements, in the BinarySearchTree
       object this
       *  TreeIterator object is iterating over, that have not been accessed by
       this
       *  TreeIterator object.
       *
      ...
      was not
       *                called before this call, or if this TreeIterator s �
      remove() method was
       *                called between the call to the next() method and this
      call.
       *
       */
      public void remove()
